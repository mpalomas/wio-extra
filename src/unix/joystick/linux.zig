...
var imports: extern struct {
    udev_new: *const fn () callconv(.c) ?*h.struct_udev,
    udev_unref: *const fn (udev: ?*h.struct_udev) callconv(.c) ?*h.struct_udev,
    udev_enumerate_new: *const fn (udev: ?*h.struct_udev) callconv(.c) ?*h.struct_udev_enumerate,
    udev_enumerate_unref: *const fn (udev_enumerate: ?*h.struct_udev_enumerate) callconv(.c) ?*h.struct_udev_enumerate,
    udev_enumerate_add_match_property: *const fn (udev_enumerate: ?*h.struct_udev_enumerate, property: [*c]const u8, value: [*c]const u8) callconv(.c) c_int,
    udev_enumerate_scan_devices: *const fn (udev_enumerate: ?*h.struct_udev_enumerate) callconv(.c) c_int,
    udev_enumerate_get_list_entry: *const fn (udev_enumerate: ?*h.struct_udev_enumerate) callconv(.c) ?*h.struct_udev_list_entry,
    udev_list_entry_get_next: *const fn (list_entry: ?*h.struct_udev_list_entry) callconv(.c) ?*h.struct_udev_list_entry,
    udev_list_entry_get_name: *const fn (list_entry: ?*h.struct_udev_list_entry) callconv(.c) [*c]const u8,
    udev_monitor_new_from_netlink: *const fn (udev: ?*h.struct_udev, name: [*c]const u8) callconv(.c) ?*h.struct_udev_monitor,
    udev_monitor_unref: *const fn (udev_monitor: ?*h.struct_udev_monitor) callconv(.c) ?*h.struct_udev_monitor,
    udev_monitor_get_fd: *const fn (udev_monitor: ?*h.struct_udev_monitor) callconv(.c) c_int,
    udev_monitor_filter_add_match_subsystem_devtype: *const fn (udev_monitor: ?*h.struct_udev_monitor, subsystem: [*c]const u8, devtype: [*c]const u8) callconv(.c) c_int,
    udev_monitor_enable_receiving: *const fn (udev_monitor: ?*h.struct_udev_monitor) callconv(.c) c_int,
    udev_monitor_receive_device: *const fn (udev_monitor: ?*h.struct_udev_monitor) callconv(.c) ?*h.struct_udev_device,
    udev_device_new_from_syspath: *const fn (udev: ?*h.struct_udev, syspath: [*c]const u8) callconv(.c) ?*h.struct_udev_device,
    udev_device_unref: *const fn (udev_device: ?*h.struct_udev_device) callconv(.c) ?*h.struct_udev_device,
    udev_device_get_property_value: *const fn (udev_device: ?*h.struct_udev_device, key: [*c]const u8) callconv(.c) [*c]const u8,
    udev_device_get_devpath: *const fn (udev_device: ?*h.struct_udev_device) callconv(.c) [*c]const u8,
} = undefined;
